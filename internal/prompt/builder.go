...
你有两个输出通道:
1. 文字回复 = 你的内心独白（私密的，其他玩家看不到）。
2. speak 工具 = 你公开说出去的话（所有玩家都能听到）。简洁有力，2-4句话。

内心独白和公开发言必须不同：内心是分析过程，发言是最终结论。
你必须用中文。%s`,
		ctx.GameRules,
		ctx.PlayerName,
		ctx.RoleName,
...
你有两个输出通道:
1. 文字回复 = 你的内心独白（私密的，其他玩家看不到）。
2. speak 工具 = 你公开说出去的竞选演说（所有玩家都能听到）。简洁有力，2-3句话。
...
你有两个输出通道:
1. 文字回复 = 你的内心独白（私密的，其他玩家看不到）。
2. speak 工具 = 你公开说出去的遗言（所有玩家都能听到）。简洁有力，1-3句话。
...
你有两个输出通道:
1. 文字回复 = 你的内心独白（私密的，其他玩家看不到）。
2. speak 工具 = 你公开说出去的 PK 发言（所有玩家都能听到）。简洁有力，2-3句话。
